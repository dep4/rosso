...
func Video(a Adaptation, r Representation) bool {
...
func (m Media) ContentProtection() *ContentProtection {
...
func Audio(a Adaptation, r Representation) bool {
...
type Represent_Func func(Adaptation, Representation) bool
